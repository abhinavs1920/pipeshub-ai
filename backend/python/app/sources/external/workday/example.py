"""Example usage of WorkdayClient and WorkdayDataSource.
...
- WORKDAY_TOKEN_ENDPOINT (e.g. "https://<tenant>.workday.com/ccx/oauth2/token")

This script demonstrates fetching the first page of workers.
"""
